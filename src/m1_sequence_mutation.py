...
def run_test_zero_changer():
    ...
    # Test 2:
    test2 = ([4, 9, 6, 2, 2], [0, 5, 0, 1, 6, 7], [3, 0, 9, 6], [8, 0, 0, 3])
    expected2 = ([4, 9, 6, 2, 2], [1, 5, 2, 1, 6, 7], [3, 3, 9, 6], [8, 4, 5, 3])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 3:
    test3 = ([1, 1, 0], [9, 0, 7, 8, 2, 0], [8, 0, 8])
    expected3 = ([1, 1, 1], [9, 2, 7, 8, 2, 3], [8, 4, 8])
    zero_changer(test3)
    print()
    print('Test 3:')
